            ...
            <div className="w-full xl:flex-1">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full h-11 pl-4 pr-10 bg-slate-950 border border-slate-800 rounded-xl text-sm font-semibold text-slate-300 focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500 outline-none transition-all appearance-none cursor-pointer hover:bg-slate-950/80"
                >
