      ...
      <div className="bg-white dark:bg-slate-900/60 backdrop-blur-sm p-2 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 flex flex-wrap xl:flex-nowrap gap-2 items-center transition-all duration-300">
        ...
        <div className="flex gap-2 ml-auto">
          ...
          <button
            ...
            title={
              !dataAvailable
                ? "Synchronize data first to enable export"
                : "Export Raw Ledger (XLSX)"
            }
            className={`h-12 w-12 flex items-center justify-center rounded-xl border transition-all active:scale-95 shadow-sm ${
              !dataAvailable || loading
                ? "bg-slate-50 dark:bg-slate-900 text-slate-300 dark:text-slate-700 border-slate-100 dark:border-slate-800 cursor-not-allowed opacity-40"
