          ...
          {tab === "RECAP" && dsrStats && (
            ...
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg overflow-hidden shadow-sm">
                  <h4 className="text-[10px] font-black uppercase text-white bg-[#001f3f] px-4 py-3">
                    Settlement Summary (By Payment Method)
                  </h4>
                    ...
                    <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                      {(data.paymentSummary || []).length > 0 ? (
                        ...
                        <tr>
                          <td
                            colSpan={3}
                            className="px-4 py-8 text-center text-slate-400 italic font-medium tracking-tight"
                          >
                            No Settlement Records Synced
                          </td>
                        </tr>
                      )}
                    </tbody>
              ...
              <div className="flex justify-center pt-6 no-print">
                ...
                >
                  {exporting ? "Finalizing PDF..." : "Export Executive DSR PDF"}
                </button>
              </div>
            </div>
          )}
