...
const getMockData = (storeId: string): FetchedData => {
  ...
  const mockDetailedMenu: MenuItemDetail[] = [
    ...
    },
    {
      ...
      grossAmountStr: "1929.00",
      totalGrossAmountStr: "23148.00",
      totalDiscountAmountStr: "0.00",
      isVoid: "N",
      voidError: "",
      voidByEmployee: "",
    },
    {
      ...
      subCategoryName: "BSL",
      quantity: 2,
      menuName: "BSL SET MENU",
      grossAmountStr: "19720.00",
      totalGrossAmountStr: "39440.00",
      totalDiscountAmountStr: "0.00",
      isVoid: "N",
      voidError: "",
      voidByEmployee: "",
